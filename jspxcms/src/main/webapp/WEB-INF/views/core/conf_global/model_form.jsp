...
<div class="c-bar margin-top5">
  <span class="c-position"><s:message code="model.management"/> - <s:message code="model.type.global"/> - <s:message code="${oprt=='edit' ? 'edit' : 'create'}"/></span>
</div>
...
<table border="0" cellpadding="0" cellspacing="0" class="in-tb margin-top5">
  ...
  <tr>
    ...
    <td class="in-ctt" width="85%" colspan="3"><s:message code="model.type.${queryType}"/><f:hidden name="type" value="global"/></td>
  </tr>
  <tr>
