...
<form id="searchForm" action="list.do" method="get">
    ...
    <label class="c-lab"><s:message code="info.creator"/>: <input type="text" name="search_EQ_creator.username" value="${requestScope['search_EQ_creator.username'][0]}" style="width:80px;"/></label>
    <label class="c-lab"><s:message code="info.author"/>: <input type="text" name="search_EQ_detail.author" value="${requestScope['search_EQ_detail.author'][0]}" style="width:80px;"/></label>
	  ...
	  <label class="c-lab">
	  	<select name="queryInfoPermType">
	  		<option value="">---<s:message code="role.infoPermType"/>---</option>
...
<div class="ls-bc-opt">
	...
	<div class="ls-btn"><input type="button" value="<s:message code="create"/>" onclick="location.href='create.do?queryNodeId=${queryNodeId}&queryNodeType=${queryNodeType}&queryInfoPermType=${queryInfoPermType}&queryStatus=${queryStatus}&${searchstring}';"/></div>
  ...
  <div class="ls-btn"><input type="button" value="<s:message code="delete"/>" onclick="return optMulti(this.form,'logic_delete.do',confirmDelete);"/></div>
  </shiro:hasPermission>
  <shiro:hasPermission name="core:info:delete">
  <div class="ls-btn"><input type="button" value="<s:message code="completelyDelete"/>" onclick="return optDelete(this.form);"/></div>
  </shiro:hasPermission>
  ...
  <div class="ls-btn"><input type="button" value="<s:message code="info.archive"/>" onclick="return optMulti(this.form,'archive.do');"/></div>
  </shiro:hasPermission>
  <shiro:hasPermission name="core:info:anti_archive">
  <div class="ls-btn"><input type="button" value="<s:message code="info.antiArchive"/>" onclick="return optMulti(this.form,'anti_archive.do');"/></div>
  </shiro:hasPermission>
   --%>
...
<table id="pagedTable" border="0" cellpadding="0" cellspacing="0" class="ls-tb">
  ...
  <tr class="ls_table_th">
    ...
    <th width="155"><s:message code="operate"/></th>
