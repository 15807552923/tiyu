...
<div class="ls-bc-opt">
  ...
  <div class="ls-btn"><input type="button" value="<s:message code="merge"/>" onclick="location.href='merge_form.do?parentId=${parent.id}&queryParentId=${queryParentId}&showDescendants=${showDescendants}&${searchstring}';"/></div>
  </shiro:hasPermission>
