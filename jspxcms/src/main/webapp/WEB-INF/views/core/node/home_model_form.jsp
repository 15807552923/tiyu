...
<div class="c-bar margin-top5">
  <span class="c-position"><s:message code="model.management"/> - <s:message code="model.type.node_home"/> - <s:message code="${oprt=='edit' ? 'edit' : 'create'}"/></span>
</div>
...
<table border="0" cellpadding="0" cellspacing="0" class="in-tb margin-top5">
  ...
  <tr>
    ...
    <td class="in-ctt" width="85%" colspan="3"><s:message code="model.type.${queryType}"/><f:hidden name="type" value="node_home"/></td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="in-lab" width="15%"><em class="required">*</em><s:message code="model.template"/>:</td>
    <td class="in-ctt" width="85%" colspan="3">
    	<f:text id="customs_template" name="customs_template" value="${bean.customs['template']}" class="required" maxlength="255" style="width:160px;"/><input id="customs_templateButton" type="button" value="<s:message code='choose'/>"/>
	    <script type="text/javascript">
	    $(function(){
