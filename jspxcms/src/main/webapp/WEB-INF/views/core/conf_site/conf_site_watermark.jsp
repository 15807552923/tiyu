      ...
      <table width="80%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="50%" height="100" valign="middle">
            <f:text id="image" name="image" value="${bean.watermark.image}" class="required" maxlength="255" onchange="fn_image('${site.filesUrl}'+this.value);" style="width:180px;"/>
            <input id="imageButton" type="button" value="<s:message code='choose'/>"/>
			      <script type="text/javascript">
			      $(function(){
			        Cms.f7.style("image",{
