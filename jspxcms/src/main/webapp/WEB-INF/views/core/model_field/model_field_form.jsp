...
<div class="c-bar margin-top5">
  <span class="c-position"><s:message code="model.management"/> - <s:message code="model.type.${model.type}"/> - <s:message code="modelField.${oprt=='edit' ? 'editField' : 'addField'}"/> - ${model.name}</span>
</div>
...
<table border="0" cellpadding="0" cellspacing="0" class="in-tb margin-top5">
  ...
  <tr class="input_type_7 input_type_51" style="display:none;">
    ...
    <td class="in-ctt" width="85%" colspan="3">
      ...
      <label><f:checkbox name="customs_imageExact" value="${bean.customs['imageExact']}" default="false"/><s:message code="modelField.imageExact"/></label>
    </td>
  </tr>
  ...
  <tr class="input_type_50" style="display:none;">
    ...
    <td class="in-ctt" width="35%">
      <select name="customs_editorToolbar" class="required">
    ...
    <td class="in-lab" width="15%"><em class="required">*</em><s:message code="modelField.editorDefault"/>:</td>
    <td class="in-ctt" width="35%">
      <select name="customs_editorDefault" class="required">
  ...
  <tr class="input_type_50" style="display:none;">
    <td class="in-lab" width="15%">UEditor<s:message code="modelField.editorToolbar.Custom"/>:</td>
    <td class="in-ctt" width="85%" colspan="3">
...
'print', 'preview', 'searchreplace', 'cleardoc', 'drafts', '|','pagebreak']]
  ...
  <tr class="input_type_50" style="display:none;">
    <td class="in-lab" width="15%">Editor.md<s:message code="modelField.editorToolbar.Custom"/>:</td>
    <td class="in-ctt" width="85%" colspan="3">    
...
"help", "info"]
    	...
    	<f:textarea name="customs_editorToolbarCustomEditormd" value="${bean.customs['editorToolbarCustomEditormd']}" default="${defaultEditorToolbarCustomEditormd}" style="width:98%;height:120px;" spellcheck="false"/>
    </td>
  </tr>
  </tbody>
  <tr>
