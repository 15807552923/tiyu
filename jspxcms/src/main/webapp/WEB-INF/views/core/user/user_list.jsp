...
<form action="list.do" method="get">
    ...
    <legend><s:message code="search"/></legend>
	  <label class="c-lab"><s:message code="user.username"/>: <input type="text" name="search_CONTAIN_username" value="${search_CONTAIN_username[0]}" style="width:120px;"/></label>
	  <label class="c-lab"><s:message code="user.realName"/>: <input type="text" name="search_CONTAIN_realName" value="${requestScope['search_CONTAIN_realName'][0]}" style="width:120px;"/></label>
	  <label class="c-lab"><s:message code="user.org"/>:
      <select name="search_STARTWITH_Jorg.treeNumber">
    ...
    <label class="c-lab"><s:message code="user.role"/>:
      <select name="search_EQ_JuserRoles.role.id">
        <option value=""><s:message code="allSelect"/></option>
    ...
    <label class="c-lab"><s:message code="user.group"/>:
      <select name="search_EQ_JuserGroups.group.id">
        <option value=""><s:message code="allSelect"/></option>
