...
<div class="c-bar margin-top5">
  <span class="c-position"><s:message code="user.management"/> - <s:message code="${oprt=='edit' ? 'edit' : 'create'}"/></span>
</div>
...
<table border="0" cellpadding="0" cellspacing="0" class="in-tb margin-top5">
  ...
  <tr>
    ...
    <td class="in-ctt" width="35%">
	    ...
	    <f:text id="orgIdName" value="${org.displayName}" class="required" readonly="readonly" style="width:160px;"/><input id="orgIdButton" type="button" value="<s:message code='choose'/>"/>
	    <script type="text/javascript">
	    $(function(){
    ...
    <td class="in-lab" width="15%"><s:message code="user.orgs"/>:</td>
    <td class="in-ctt" width="35%">
	    <div id="orgIds">
	    ...
	    <f:text id="orgIdsNameDisplay" value="" readonly="readonly" style="width:160px;"/><input id="orgIdsButton" type="button" value="<s:message code='choose'/>"/>
	    <script type="text/javascript">
	    $(function(){
  ...
  <tr>
    ...
    <td class="in-ctt" width="35%"><f:text name="username" value="${oprt=='edit' ? (bean.username) : ''}" class="{required:true,remote:{url:'check_username.do',type:'post',data:{original:'${oprt=='edit' ? (bean.username) : ''}'}},messages:{remote:'${usernameExist}'}}" style="width:180px;"/></td>
    <td class="in-lab" width="15%"><s:message code="user.realName"/>:</td>
    <td class="in-ctt" width="35%"><f:text name="realName" value="${bean.realName}" maxlength="100" style="width:180px;"/></td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="in-lab" width="15%"><s:message code="user.groups"/>:</td>
    <td class="in-ctt" width="85%" colspan="3">    	
    		<f:checkboxes name="groupIds" items="${groupList}" checked="${bean.groupsExcludeMain}" itemLabel="name" itemValue="id"/>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="in-ctt" width="35%"><f:text name="qqOpenid" value="${bean.qqOpenid}" maxlength="64" style="width:180px;"/></td>
    <td class="in-lab" width="15%"><s:message code="user.weiboUid"/>:</td>
    <td class="in-ctt" width="35%"><f:text name="weiboUid" value="${bean.weiboUid}" maxlength="64" style="width:180px;"/></td>
  </tr>
  <tr>
