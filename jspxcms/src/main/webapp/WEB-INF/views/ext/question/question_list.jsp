...
<div class="c-bar margin-top5">
  <span class="c-position"><s:message code="question.management"/> - <s:message code="list"/></span>
...
<form action="list.do" method="get">
    ...
    <legend><s:message code="search"/></legend>
	  <label class="c-lab"><s:message code="question.title"/>: <input type="text" name="search_CONTAIN_title" value="${search_CONTAIN_title[0]}"/></label>
