...
<div class="c-bar margin-top5">
  <span class="c-position"><s:message code="vote.management"/> - <s:message code="list"/></span>
...
<form action="list.do" method="get">
    ...
    <legend><s:message code="search"/></legend>
	  <label class="c-lab"><s:message code="vote.title"/>: <input type="text" name="search_CONTAIN_title" value="${search_CONTAIN_title[0]}"/></label>
...
<div class="ls-bc-opt">
	...
	<shiro:hasPermission name="ext:vote:edit">
...
<table id="pagedTable" border="0" cellpadding="0" cellspacing="0" class="ls-tb margin-top5">
  ...
  <tr<shiro:hasPermission name="ext:vote:edit"> ondblclick="location.href=$('#edit_opt_${bean.id}').attr('href');"</shiro:hasPermission>>
