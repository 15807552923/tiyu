...
<div class="c-bar margin-top5">
  <span class="c-position"><s:message code="ad.management"/> - <s:message code="list"/></span>
...
<form action="list.do" method="get">
    ...
    <legend><s:message code="search"/></legend>
	  <label class="c-lab"><s:message code="ad.name"/>: <input type="text" name="search_CONTAIN_name" value="${search_CONTAIN_name[0]}"/></label>
	  <label class="c-lab"><s:message code="ad.slot"/>:
	  	<select name="search_EQ_slot.id">
