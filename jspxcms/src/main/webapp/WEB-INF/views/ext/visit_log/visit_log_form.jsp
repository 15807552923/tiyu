...
<div class="c-bar margin-top5">
  <span class="c-position"><s:message code="visitLog.management"/> - <s:message code="${oprt=='edit' ? 'edit' : 'create'}"/></span>
</div>
...
<table border="0" cellpadding="0" cellspacing="0" class="in-tb margin-top5">
  ...
  <tr>
    <td class="in-lab" width="15%"><s:message code="visitLog.time"/>:</td>
    <td class="in-ctt" width="35%">
    	<input type="input" value="<fmt:formatDate value="${bean.time}" pattern="yyyy-MM-dd HH:mm:ss"/>" readonly="readonly" style="width:180px;"/>
    </td>
    <td class="in-lab" width="15%"><s:message code="visitLog.ip"/>:</td>
  ...
  <tr>
    <td class="in-lab" width="15%"><s:message code="visitLog.referrer"/>:</td>
